...
df_DressSales['Total Sales'] = df_DressSales.iloc[:,1:24].sum(axis = 1)
...
third_highest_Sold_ID = int(df_Total_Sales.sort_values(by = "Total Sales", ascending=False, ignore_index= True).loc[2][0])
